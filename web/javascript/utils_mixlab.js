...
loadExternalScript('/8i/app/lib/pickr.min.js')
...
app.registerExtension({
  ...
  init () {
    $el('link', {
      rel: 'stylesheet',
      href: '/8i/app/lib/classic.min.css',
      ...
      TCOLOR (node, inputName, inputData, app) {
        ...
        const widget = {
          ...
          async serializeValue (nodeId, widgetIndex) {
            // let data = getLocalData('_8i_utils_color')
  ...
  async beforeRegisterNodeDef (nodeType, nodeData, app) {
    if (nodeType.comfyClass == 'Color') {
      ...
      nodeType.prototype.onNodeCreated = function () {
        ...
        let inputColor = inputDiv('_8i_utils_color', 'Color', '#000000')
        ...
        pickr
          .on('save', (color, instance) => {
            ...
            // localStorage.setItem('_8i_utils_color', JSON.stringify(data))
...
app.registerExtension({
    ...
    return {
      KEY (node, inputName, inputData, app) {
        ...
        const widget = {
          ...
          async serializeValue (nodeId, widgetIndex) {
            let data = getLocalData('_8i_llm_api_key')
  ...
  async beforeRegisterNodeDef (nodeType, nodeData, app) {
    if (nodeType.comfyClass == 'KeyInput') {
      ...
      nodeType.prototype.onNodeCreated = function () {
        ...
        let inputKey = inputDiv('_8i_llm_api_key', 'Key')
  ...
  async loadedGraphNode (node, app) {
    if (node.type === 'KeyInput') {
      ...
      let apiKey = getLocalData('_8i_llm_api_key')
